...
{
	partial class ChkVehPaidDialog1
	{
		/// <summary>
		...
		private void InitializeComponent()
		{
			...
			this.label1.Text = "Enter car registration to be checked please";
			// 
			// ChkVehPaidDialog1
			// 
			...
			this.Name = "ChkVehPaidDialog1";
			this.Text = "Check if Vehicle has paid";
